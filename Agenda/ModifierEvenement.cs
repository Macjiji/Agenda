...
namespace Agenda
{
    [Activity(Label = "ModifierEvenement")]
    public class ModifierEvenement : Activity, DatePickerDialog.IOnDateSetListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.ModifierEvenement);
        ...
        private void InitialiseBoutons()
        {
            ...
            boutonValider.Click += delegate
            {
                ...
                {
                    baseDeDonnees.UpdateEvent(evenement);
        ...
        {
            evenement = baseDeDonnees.GetEventWithName(Intent.GetStringExtra("nom"));
            ...
            dateEvenement.Text = evenement.Jour + "/" + (evenement.Mois + 1) + "/" + evenement.Annee;
